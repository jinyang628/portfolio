...
export default function Navigation() {
  ...
  return (
    <nav className="flex items-center space-x-3">
      ...
      <Link
        href={ROUTE.notes}
        className={`rounded-md px-3 py-2 text-sm font-medium ${pathname === '/notes' ? 'bg-black text-white dark:bg-white dark:text-black' : 'text-black-300 hover:bg-gray-500 hover:text-white'}`}
      >
        Notes
      </Link>
    </nav>
